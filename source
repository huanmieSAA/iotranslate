...
(function() {
    ...
    const textMap = {
      ...
      "DESKTOP": "桌面版",
      "GET": "获取",
      "puzzle together in this modern yet familiar online stacker. play against friends and foes all over the world, or claim a spot on the leaderboards - the stacker future is yours!": "遨游现代而熟悉的堆方块在线对战。与世界各地的朋友和对手对战，在排行榜上占据一席之地——方块的未来在您手中！",
      ...
      "to register, please choose a password for yourself": "想要注册，请为自己选择一个密码",
        //登录相关文本
      ...
      "are you": "是你",
      "TETR.IO has a policy of": "TETR.IO有一个政策是",
      "one account per person (anonymous accounts excluded)": "每人仅能拥有一个账户（不包括匿名账户）",
      ". making multiple accounts may result in permanent restriction of all your accounts.": ".开设多个账户可能会导致你的所有账户被永久限制。",
      "read the": "阅读",
      "full policy": "完整的政策",
      "for more info. in doubt, or if you believe your usage of a second account is justified, please": "如果有疑问，或者你认为你使用第二个账户是合理的，请联系我们。",
      ...
      "enter matchmaking and you will be matched up with a player of similar skill in a game of 1v1 VERSUS.": "进入匹配后您将和一个水平相似的玩家进行一场1对1的对战。",
      ...
      "if you leave the game early at any point, you will be awarded a loss. go conquer the ranks!": "如果在游戏中途退出，您将会被判定为失败。去挑战排行榜上的其他玩家吧！",
      "LEADERBOARDS": "排行榜",
      "estimated queue time:": "预计等待时间：",
      "GET READY FOR": "做好准备，迎接",
      "THE NEXT BATTLE": "下一场战斗",
      "face off against others and rise up through the ranks!": "与他人对决，并获得段位提升！！",
        //快速游戏相关文本
      "QUICK PLAY": "快速游戏",
      "jump into a currently ongoing match": "加入正在进行的比赛",
      "CHAT": "聊天",
      "Welcome to Quick Play chat! Please remember to be civil to your opponents - chat is actively monitored.": "欢迎来到快速游戏聊天室！请记得对你的对手保持礼貌——聊天记录将被实时监控。",
      "left the room": "离开房间",
      ...
      "game finished": "游戏结束",
      "welcome to ": "欢迎来到",
      "is a free familiar yet fast-paced online stacker in the same genre as tetris, and played by millions across the globe.": "是一款免费的快节奏俄罗斯方块类在线益智游戏，拥有数百万全球玩家。",
      ...
      "EDIT": "退出",
      "you just joined QUICK PLAY - you will play in the next game in this lobby. please wait for the current game to finish. feel free to spectate or play ZEN while waiting!": "您加入了快速游戏 - 请等待结束然后加入下一局。在等待时，您可以选择旁观或游玩单人的禅模式！",
      ...
      "Super Lobby Mode Engaged - congratulations on hitting 100 players! Joins and leaves will be suppressed, and the winner of games in this room will earn a special profile badge!": "超级房间模式开启--达到了100名玩家! 加入和离开将被限制，本局游戏的赢家将获得一个特殊的个人资料徽章!",
      ...
      "Welcome to chat! Please remember to be civil to your opponents.": "欢迎来到聊天室! 请记住，要对你的对手保持文明。",
      "ROOM": "房间",
      "MATCH": "比赛",
      "GAME": "对局",
      "room name": "房间名",
      ...
      "allow unranked users to play": "允许没有段位的用户进行游戏",
      "RANK LIMIT": "段位限制",
      ...
      "settings copied directly from TETR.IO's matchmaking rooms! margin times and match goals are shifted slightly with duels in mind.": "设置直接从TETR.IO的TETRA联赛中复制！考虑到决斗，死线时间和比赛目标略有改变。",
      "an endurance-focused challenge of pure stacking intellect! almost every value is changed to imitate stacker games made many years ago.": "一个以耐力为重点的纯粹堆叠的智力挑战！几乎每一个数值都被改变，以模仿多年前的方块游戏。",
      "featuring innovative mechanics created for a popular stacker found in arcades, this preset puts a focus on smart stacking and mastery with its custom kick table!": "这个预设的特点是街机中流行的方块游戏创建的创新机制，这个预设将重点放在有策略的堆叠和掌握其定制的踢墙表上",
      "this preset introduces several forms of enforced handling which introduces a generous skill ceiling! puts a focus on efficient and consistent play, as opposed to deafeningly fast rounds.": "这个预设引入了几种形式的强制处理，引入了一个极高的技能上限！把重点放在高效和稳定的堆叠攻击上，而不是震耳欲聋的快速回合。",
      ...
      "everything is a spin because YEAH WHY NOT (O-spin SUPPORTED!)": "一切都是旋转的，因为是的，为什么不呢（O-spin支持！）？",
      ...
      "novel rotation system by DR OCELOT": "洛克洛特博士的新型旋转系统",
      "the classic rotation system": "经典旋转系统",
      "rotation system used in arcade games": "在街机游戏中使用的旋转系统。",
      "permissive rotation system by WINTERNEBS": "WINTERNEBS允许的旋转系统",
      ...
      "board width": "游戏区域宽度",
      "board height": "游戏区域高度",
      "WARNING: server restarting soon!": "WARNING: server restarting soon!",
      "COMBO BLOCKING": "连击阻挡",
      "incoming garbage will be delayed and reduced on successive line clears": "垃圾行会在连续消除行后延迟并减少到达",
      "LIMITED BLOCKING": "限制阻挡",
      "incoming garbage can be reduced only once per next immediate piece": "垃圾行只能在下一个方块到来前减少一次",
      "incoming garbage cannot be blocked": "无法阻止垃圾行的到来",
        //房间列表相关文本
      "ROOM LISTING": "房间列表",
      "join public custom games": "加入公共自定义房间",
      "REFRESH": "刷新",
      "anons allowed:": "允许匿名：",
      ", unranked allowed:": "，允许无段位的：",
      "YES": "是的",
      "NO": "不",
      "and below -": "及以下",
      "INGAME -": "在游戏中 -",
      ...
      "leaderboards, replays and more": "排行榜、重播等",
      ...
      "maximum COMBO":"最大连击数",
      "maximum back-to-back chain":"最多back-to-back连锁",
      "finesse %":"极简率",
      ...
      "adjust the feel or help train using the ZEN SIDEBAR.": "使用禅模式侧边栏调整心境或进行训练",
      "you can undo and redo placements with CTRL+Z and CTRL+Y!": "你可以用CTRL+Z和CTRL+Y来撤销和重新放置方块!",
        //禅模式局内的文本
      ...
      "controllers can be set up in CUSTOM controls - just press the controller buttons you wish to bind.": "键位可以在自定义中设置 - 只需点击想要更改的键位并按下你想绑定的按键。",
      ...
      "spin board when you T-spin": "tspin时旋转场地",
      ...
      "always play notification sounds at full volume": "提示音效永远很响",
      ...
      "YOU ARE ALREADY IN THE ROOM": "你已经在该房间准备了",
      ...
      "bgm": "音乐",
      "TETR.IO DESKTOP should open soon!": "TETR.IO 桌面版应该很快就会开放!",
      ...
      "You have been awarded a loss for this match. Please ensure you have the time and internet connection to play! Repeated forfeits are punished (and will be automatically punished in the future). Thank you for understanding!": "你在这场比赛中被判为失败。请确保你有时间和网络连接来进行比赛! 屡次弃权将受到惩罚（今后将自动受到惩罚）。谢谢您的理解!",
      ...
      "Please be civil. Staff will never ask for your credentials.": "请文明聊天。官方永远不会要求你的证件。",
      "ONLINE": "在线",
      "Away": "离开",
      "Playing": "正在玩",
      "Busying": "正忙",
      ...
      "GET TETR.IO DESKTOP!": "获取tetr.io桌面版!",
      ...
      "YOU HAVE BEEN BLOCKED FROM TETR.IO": "您已被阻止进入tetr.io网站",
