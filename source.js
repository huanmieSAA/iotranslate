...
(function() {
    ...
    const textMap = {
        ...
        "TETR.IO DESKTOP is automatically set up to bring the smoothest experience, with far better performance and less setup hassle. install it with the button below!": "TETR.IO 桌面客户端的自动设置带来了最流畅的体验，具有更好的性能和更少的设置麻烦。用下面的按钮安装它!",
