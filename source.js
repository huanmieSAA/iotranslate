...
(function() {
    ...
    const textMap = {
        ...
        "Use a compatibility mode for WebGL If you experience unexplainable flickering,try this mode": "",
        "Use WebGL 1. If you see artifacts on screen, try this mode.": "",
        ...
        "How visible the background images are.0%makes the background entirely black.": "",
        "If enabled, prioritize power saving over performance.": "",
        "If enabled, render blurrier but prettier.": "",
        "If enabled, don't show as much precision on in-game counters. Speeds up the game significantly": "",
        "If enabled, always shows the simpler thumbnails for other players. This increases performance in games between 2 and 10 players, but looks less nice": "",
        "If enabled,the background of Super Lobbies (rooms of 100+players)does not animate (outside of the intro)": "",
        "If enabled, do not show the background when in menus. This will majorly improve performance in menus, but you will no longer see the background": "",
        "If enabled, profanity in chat will be filtered. Note that such filters are never perfect.": "",
        "If enabled, chat will be hidden when ingame.": "",
        "If enabled, room IDs will not be shown, to protect you from streamsniping.": "",
        "If enabled, show emotes in chat.": "",
        "If enabled, show animated emotes in chat.": "",
        "If enabled, chat text shows in black(good for light backgrounds).": "",
        "If enabled, show a background behind chat messages when typing.": "",
        "If enabled, the replay tools do not collapse when you' re not using them.": "",
        "If enabled, network warning icons will not be shown.": "",
        "If enabled,a warning is shown when TETR. IO is out of focus.": "",
        "If enabled, show the simple guide with the keybinds in multiplayer lobbies.": "",
        "If enabled, show notifications outside of the game.": "",
        "If enabled, unimportant notifications don't show ingame, but will be shown after the game.": "",
        "If enabled, notification sounds always play at full volume.": "",
        "Don't notify me.": "",
        "Only notify me ingame.": "",
        "Notify me ingame and with a desktop notification.": "",
        "If enabled, show a custom background image. If disabled, uses default background.": "",
        "Save your new privacy settings.": "",
        "If enabled, show how much time you' ve played TETR. IO for.": "",
        "If enabled, show your amount of online games won on your profile.": "",
        "If enabled, show your amount of online games played on your profile.": "",
        "If enabled, show your country as a flag on your profile.": "",
        "Only people who you' ve added as friend can add you as friend.": "",
        "Anyone can add you as friend.": "",
        "Nobody can see whether you' re online. Not recommended.": "",
        "Only people who you' ve added as friend can see whether you' re online.": "",
        "Anyone can see whether you' re online.": "",
        "Nobody can see what you' re doing.": "",
        "Only people who you' ve added as friend can see what you' re doing.": "",
        "Anyone can see what you' re doing.": "",
        "Nobody can see what room you' re in.": "",
        "Only people who you' ve added as friend can see what room you' re in.": "",
        "Anyone can see what room you' re in.": "",
        "Nobody can send you direct messages.": "",
        "Only people who you' ve added as friend can send you direct messages.": "",
        "Anyone can send you direct messages.": "",
        "Nobody can send you invites.": "",
        "Only people who you' ve added as friend can send you invites.": "",
        "Anyone can send you invites.": "",
        "Save your new username.": "",
        "Save your new email.": "",
        "Save your new password.": "",
        "Enable two-factor authentication.": "",
        "Link your Discord account.": "",
        "Delete your account and everything involved.": "",
        "Further customize this mode": "",
        "Show extra info and arrange some info for pro players.": "",
        "Alert me when I make a finesse fault.": "",
        "Restart the game when I make a finesse fault.": "",
        "Speeds up animations, disables hold-to-retry and prevents the first piece from being S,Z or O.": "",
        "The type of metric to display in the first left-hand slot.": "",
        "The type of metric to display in the second left-hand slot.": "",
        "The type of metric to display in the third left-hand slot.": "",
        "The type of metric to display in the fourth left-hand slot.": "",
        "The type of metric to display in the right-hand slot.": "",
        "": "",
        "": "",
        "": "",
        "": "",
