...
(() => {
    ...
    const textMap = {
        ...
        "PLAYERS (": "玩家数（",
        "welcome to the ZENITH TOWER! send lines and KO enemies to scale the tower.":"欢迎来到天顶之塔！发送垃圾行并击倒敌人即可攀登塔楼",
        ...
        "BLITZER": "BLITZ爱好者",
        "BLITZ games completed": "BLITZ完成次数",
        ...
        "Stack with explosive passion, and overwhelm even the most poised of masters.": "功夫再高，也怕菜刀。",
        "PLONK": "太极爱好者",
        ...
        "We'll make it to the top. Together.": "我们终会一起抵达顶峰。",
        "TOWER CLIMBER": "攀塔爱好者",
