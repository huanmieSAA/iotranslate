...
// @version      1.2.2
// @description  将TETR.IO中的内容翻译成中文并自动刷新保证翻译内容基本完成，对性能可能有一点影响 鸣谢：mrz,xb以及各位群友1.2.2更新：完全修复已知问题，更新部分悬停文本
// @match        https://*.tetr.io/*
// @grant        none
// ==/UserScript==
...
(function() {
    ...
    const textMap = {
        ...
        //悬停详情文本
        "Change the way you control TETR.IO": "改变你控制 TETR.IO 的按键",
        "Change the way TETR.IO feels": "改变你玩 TETR.IO 的手感",
        "Change the way TETR.IO sounds": "改变 TETR.IO 的声音",
        "Change the way TETR.IO functions": "改变 TETR.IO 的功能设置",
        "Change the way TETR.IO looks": "改变 TETR.IO 的视觉效果",
        "Change the way TETR.IO notifies you": "改变 TETR.IO 通知你的方式",
        "Add your own personal spin to TETR.IO": "为 TETR.IO 添加你自己的个人特色",
        ...
        "A WASD-based layout, that sets piece movement to the left hand and rotation to the right.": "基于 WASD 的布局，将方块的移动设置为左手，旋转设置为右手。",
        ...
        "DAS Cut Delay: if not 0, any ongoing DAS movement will pause for a set amount of time after dropping/rotating a piece, measured in frames.": "DAS 切断延迟，如果不为 0，任何正在进行的 DAS 运动将在下落/旋转一个方块后暂停一段设定的时间，以帧计算。",
        ...
        "If enabled, DAS charge is cancelled when you change directions.": "如果启用：当你中途改变移动方向时，DAS 充能会重新计算。",
        ...
        "How much stereo to apply. A value of 0% means all sound is centered, whereas a value of 100% plays sounds that happen aside your board on different ears.": "应用多少立体声。0% 的值意味着所有的声音都在中心位置，而 100% 的值则是在不同的耳朵上播放发生在你游戏中的声音。",
        "Whether to allow scrolling ingame (or holding ALT and scrolling anywhere) to change the volume.": "是否允许在游戏中用滚轮（或按住 Alt 并滚动到任何地方）来改变音量。",
        ...
        "If enabled, no audio will ever play. This will speed up the game, with a rather obvious drawback.": "如果启用，将永远不会有音频播放。这将加快游戏的速度，但有一个相当明显的缺点。",
        ...
        "How visible the grid is. 0% makes the grid invisible.": "网格的可见程度。0% 时使网格不可见。",
        "How visible the board is. 0% makes the board invisible.": "背景的可见度。0% 时使背景不可见。",
        "How visible the shadow piece is. 0% makes the shadow piece invisible.": "阴影部分的可见程度。0% 使阴影部分不可见。",
        "How large the board displays. Values over 100% may cause some elements to not be visible.": "显示多大的板面。超过 100% 的值可能会导致一些元素不可见。",
        "Whether to display a duel side-by-side. This causes your own board to move slightly to the left.": "是否并排显示决斗.这将使你自己的板面稍微向左移动。",
        "When enabled, the board reacts to T-Spins by rotating a little with it.": "启用后，板面对 T-Spin 的反应是随着它旋转一点。",
        "If enabled, show a popup when you KO someone or get KO'd.": "如果启用，当你 KO 某人或被 KO 时显示一个弹出窗口。",
        ...
        "If enabled, the background music will be muted when TETR.IO is minimized or tabbed away.": "如果启用，当 TETR.IO 最小化或标签化时，背景音乐将被静音。",
        ...
        "Use a compatibility mode for WebGL If you experience unexplainable flickering,try this mode": "使用 WebGL 的兼容模式，如果你遇到无法解释的闪烁，请尝试这个模式",
        "Use WebGL 1. If you see artifacts on screen, try this mode.": "使用 WebGL 1 如果你在屏幕上看到渲染错误，请尝试这个模式。",
        "Use the newest WebGL 2. Best (and default) option, but might not be supported properly on all devices. Some devices/browsers ignore this option and use WebGL 1-check the Console (F12->Console) to see which is being used.": "使用最新的 WebGL 2。最佳（和默认）选项，但可能不是所有设备都能正确支持。有些设备/浏览器会忽略这个选项，而在控制台中可以查看正在使用的是哪一种（F12 -> 控制台）。",
        "How many particles to display.": "要显示多少粒子",
        "How visible the background images are.0%makes the background entirely black.": "背景图像的可见度。0% 时使背景完全变成黑色。",
        "If enabled, prioritize power saving over performance.": "如果启用，优先考虑省电而不是性能。",
        "If enabled, render blurrier but prettier.": "如果启用，会渲染得更模糊，但更视觉感受更柔和。",
        "If enabled, don't show as much precision on in-game counters. Speeds up the game significantly": "如果启用，会减少游戏中计时器的小数点。显著加快游戏速度",
        "If enabled, always shows the simpler thumbnails for other players. This increases performance in games between 2 and 10 players, but looks less nice": "如果启用，在游戏时会将玩家显示为简单的缩略图，这提高了 2 到 10 个玩家之间时的游戏性能，但看起来不那么漂亮。",
        "If enabled,the background of Super Lobbies (rooms of 100+players)does not animate (outside of the intro)": "如果启用，超级房间（人数 100 以上的房间）的背景不会有动画（除了开局动画时）。",
        "If enabled, do not show the background when in menus. This will majorly improve performance in menus, but you will no longer see the background": "如果启用，在菜单中不显示背景。这将大大改善菜单的性能，但你将不再看到背景。",
        "If enabled, profanity in chat will be filtered. Note that such filters are never perfect.": "如果启用，聊天中的脏话将被过滤掉。请注意，这样的过滤器不可能完美。",
        "If enabled, chat will be hidden when ingame.": "如果启用，聊天将在游戏中被自动隐藏。",
        "If enabled, room IDs will not be shown, to protect you from streamsniping.": "如果启用，房间 ID 将不被显示，以防止你在串流时被狙击。",
        "If enabled, show emotes in chat.": "如果启用，在聊天中显示表情。",
        "If enabled, show animated emotes in chat.": "如果启用，在聊天中显示动画表情。",
        ...
        "If enabled, the replay tools do not collapse when you' re not using them.": "如果启用，当你不使用回放工具时，重放工具不会折叠。",
        "If enabled, network warning icons will not be shown.": "如果启用，将不显示网络警告图标。",
        "If enabled,a warning is shown when TETR. IO is out of focus.": "如果启用，当 TETR.IO 失焦时，会显示一个警告。",
        "If enabled, show the simple guide with the keybinds in multiplayer lobbies.": "如果启用，在多人游戏大厅中会显示当前键位设置的简单指南。",
        "If enabled, show notifications outside of the game.": "如果启用，在游戏外会显示通知。",
        "If enabled, unimportant notifications don't show ingame, but will be shown after the game.": "如果启用，不重要的通知不会在游玩中显示，但会在游戏后显示。",
        "If enabled, notification sounds always play at full volume.": "如果启用，通知声音会以全音量播放。",
        "Don't notify me.": "不要通知我。",
        "Only notify me ingame.": "只能在游戏内通知我。",
        ...
        "If enabled, show how much time you' ve played TETR. IO for.": "如果启用，将在个人资料中显示你的 TETR.IO 游玩时长",
        "If enabled, show your amount of online games won on your profile.": "如果启用，将在个人资料中显示您赢的游戏对局数量。",
        "If enabled, show your amount of online games played on your profile.": "如果启用，将在个人资料中显示您总游戏对局数量。",
        "If enabled, show your country as a flag on your profile.": "如果启用，将你的国家作为国旗显示在你的个人资料上。",
        "Only people who you' ve added as friend can add you as friend.": "只有被你加为好友的人才能加你为好友。",
        ...
        "Nobody can send you direct messages.": "没有人可以给你发信息。",
        "Only people who you' ve added as friend can send you direct messages.": "只有被你加为好友的人才能给你发送信息。",
        "Anyone can send you direct messages.": "任何人都可以给你发信息。",
        ...
        "Save your new email.": "保存你的新邮件。",
        "Save your new password.": "保存你的新密码。",
        "Enable two-factor authentication.": "启用双因素认证。",
        "Link your Discord account.": "链接你的 Discord 账户。",
        "Delete your account and everything involved.": "删除你的账户和所涉及的一切。",
        "Further customize this mode": "进一步自定义该模式",
        "Show extra info and arrange some info for pro players.": "显示更多信息，为专业的玩家准备",
        "Alert me when I make a finesse fault.": "当我没极简时提醒我。",
        "Restart the game when I make a finesse fault.": "当我没极简时重开这局游戏。",
        "Speeds up animations, disables hold-to-retry and prevents the first piece from being S,Z or O.": "加快动画速度，禁用长按重试的功能，并防止第一个方块是 S、Z 或 O。",
        "The type of metric to display in the first left-hand slot.": "左侧第一个信息槽显示的信息",
        "The type of metric to display in the second left-hand slot.": "左侧第二个信息槽显示的信息",
        "The type of metric to display in the third left-hand slot.": "左侧第三个信息槽显示的信息",
        "The type of metric to display in the fourth left-hand slot.": "左侧第四个信息槽显示的信息",
        "The type of metric to display in the right-hand slot.": "右侧信息槽显示的信息",
        "": "",
        "": "",
        "": "",
        "": "",
        ...
        "games played": "对局场数",
        "hours played": "总游戏时长",
        "welcome to TETR.IO": "欢迎来到 TETR.IO ",
        "open in": "打开",
        "DESKTOP": "桌面客户端",
        "GET": "获取",
        ...
        "is this you?": "这是你吗？",
        "LOG OUT": "退出登录",
        "welcome back to TETR.IO!": "欢迎回到 TETR.IO!",
        "are you": "是你",
        "TETR.IO has a policy of": "TETR.IO 有一条政策：",
        ...
        "Please remember to be civil to your opponent.":"",
        //快速游戏相关文本
        "QUICK PLAY": "快速游戏",
        ...
        "bgm": "音乐",
        "TETR.IO DESKTOP should open soon!": "TETR.IO 桌面客户端应该很快就会打开!",
        ...
        "already on desktop? you may need to restart your device.": "使用的已经是桌面客户端了？你可能需要重新启动设备。",
        "GET TETR.IO DESKTOP!": "获取 TETR.IO 桌面客户端!",
    ...
    function replaceTooltips(event) {
        ...
        if (title && textMap.hasOwnProperty(title)) {
            tooltip.setAttribute('title', textMap[title]);
    ...
    document.addEventListener('mouseleave', function(event) {
        const target = event.target;
        if (target.hasAttribute('title') && textMap.hasOwnProperty(target.getAttribute('title'))) {
            target.setAttribute('title', textMap[target.getAttribute('title')]);
