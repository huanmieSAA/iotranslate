...
// @version      1.2.9
// @description  将TETR.IO中的内容翻译成中文并自动刷新保证翻译内容基本完成，对性能可能有一点影响 鸣谢：mrz,xb，zhazha120以及各位群友。1.2.9更新：添加赛季结束文本和部分自定义房间文本大家有遇到没翻的文本可以截图发送到xchen5939@gmail.com我会及时添加
// @match        https://*.tetr.io/*
