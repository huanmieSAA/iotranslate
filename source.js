...
(() => {
    ...
    const textMap = {
        ...
        "highest floor discovered while using 7/8 of the difficulty mods ("Duo" not allowed)":"",
        "BLOCK RATIONING":"",        
        "highest total attack within the first 400 pieces placed while using the "Expert Mode" and "Messier Garbage" mods":"",
        "Adversity favors the resourceful.":"",
        "TALENTLESS":"",
        "highest floor discovered while using the "All-Spin" mod without performing any Spins":"",        
        "Reaching deep down but coming back empty every time.":"",
        "":"",
        "":"",
        "":"",
        "":"",
    ...
    const tooltipMap = {
        ...
        "Whether to reward clearing the entire board": "清除所有方块后是否进行奖励攻击",
