...
(function() {
    ...
    const textMap = {
      ...
      "render at a low resolution": "在低分辨率下渲染",
      ...
      "two-factor authentication is": "双因素认证",
      "NOT ENABLED": "未启用",
      "ENABLE": "启用",
      ...
      "FRIEND": "加为好友",
      "ANONYMOUS": "匿名",
      "If someone outside of your friends list messages you, they'll appear here.": "如果你的好友名单之外的人给你发信息，他们会出现在这里。",
      "Not connected to online servers. Sit tight, we'll try to reconnect you in the background.": "没有连接到在线服务器。请坐好，我们将尝试在后台重新连接你。",
      "cheese messiness %": "奶酪混乱率",
      ...
      "it seems WEBGL is disabled in your browser. WEBGL is required for the game to render properly.": "看来你的浏览器中禁用了WEBGL。游戏需要WEBGL才能正常渲染。",
      ...
      "already on desktop? you may need to restart your device.": "已经在桌面上了吗？你可能需要重新启动你的设备。",
      "GET TETR.IO DESKTOP!": "获取tetr.io桌面版!",
      "this ban only covers your network (IP). your account is": "这个禁令只包括你的网络（IP）。你的账户是",
      "not banned": "没有被禁用的",
      "! please turn off any VPN/proxy, and/or try from a different network. in most cases, ": "请关闭任何VPN/代理，从不同的网络尝试，在大多数情况下、",
      "support cannot help you here.": "支持在这里不能帮助你。",
      "if you believe you were banned in error,": "如果你认为你被禁赛是错误的、",
